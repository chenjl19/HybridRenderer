#include "global.inc"
#include "shadowViewConstants.inc"
...
float4 StaticModelDepthOnlyVS(in DRAWVERT_Packed0Input a2v) : SV_POSITION {
    ...
    float4 positionCS = mul(_ViewProjectionMatrix, float4(positionWS, 1));
...
v2f StaticModelAlphaTestVS(in DRAWVERT_Packed0Input a2v) {
    ...
    output.pos = mul(_ViewProjectionMatrix, float4(positionWS, 1));
